...
<br>
  ...
  <form action="../validateservlet" method="post" class="createAccform" >
    <h2 class="u-lg-h">View Sponsorship</h2>
     
    <table class="form-table" >
      <tr>
        <td><label class="form-lable">Enter Company name</label></td>
