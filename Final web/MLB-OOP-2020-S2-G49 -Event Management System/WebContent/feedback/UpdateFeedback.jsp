...
<form action="../updatefdservlet" method="post" class="createAccform" >
<h2 class="u-lg-h">Update Your feedback</h2>
	<table class="form-table" >
		...
		<tr>
			...
			<td><input class="form-input" type="text" name="name"  value="<%=name %>"></td>
		</tr>
		<tr>
			<td class="form-lable">Feedback </td>
			<td><textarea class="form-input" style="height: 300px;" name="fdbk" ><%=fdbk %></textarea></td>
		</tr>
