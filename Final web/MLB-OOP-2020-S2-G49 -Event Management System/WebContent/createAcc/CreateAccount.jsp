...
<br>
  ...
  <form action="../createuser" method="post" class="createAccform" onkeyup="validate();">
    <h2 class="u-lg-h">Create User Account</h2>
     
    <table class="form-table" >
      <tr>
        <td><label class="form-lable">Name</label></td>
        <td><input type="text" name="name" class="form-input" id="name" ><br><small id="nameErr"></small></td>
      </tr>
      <tr>
        <td><label class="form-lable">User name</label></td>
        <td><input type="text" name="username" class="form-input" id="uname"><br><small id="unameErr"></small></td>
      </tr>
      <tr>
        <td><label class="form-lable">NIC </label></td>
        <td><input type="text" name="unic" class="form-input" id="nic" placeholder="123456789V"><br><small id="nicErr"></small></td>
      </tr>
      <tr>
        <td><label class="form-lable">Email</label></td>
        <td><input type="text" name="uemail"  id="email" placeholder="abc@gmail.com"  class="form-input"><br><small id="emailErr"></small> </td>
        
      </tr>
      <tr>
        <td><label class="form-lable">Phone</label></td>
        <td><input type="text" name="uphone"  id="phone" class="form-input"><br><small id="phoneErr"></small></td>
      </tr>
      <tr>
        <td><label class="form-lable">Address</label></td>
        <td><input type="text" name="uaddr" id="addr" class="form-input"><br><small id="addrErr"></small></td>
      </tr>
      <tr>
        <td><label class="form-lable">Account Type</label></td>
        <td><select name="uaccType" class="form-input" id="acct" >
            <option selected="selected" >Select account type</option>
            <option value="customer">Customer</option>
            <option value="sponser">Sponsor</option>
        </select><br><small id="acctErr"></small></td>
      </tr>
      <tr>
        <td><label class="form-lable">Password</label></td>
        <td><input type="password" name="upass" id="pswd1" placeholder="********" class="form-input"> <a  class="psBtn"><i class="fa fa-eye-slash" id="faEye1" onclick="showpw1()"></i></a>
          <br><small id="pswd1Err"></small>
       </td>
      </tr>
      <tr>
        <td><label class="form-lable">Re-typePassword</label></td>
        <td><input type="password" class="form-input"  placeholder="********" id="pswd2"> <a  class="psBtn"><i class="fa fa-eye-slash" id="faEye2" onclick="showpw2()"></i></a><br><small id="pswd2Err"></small>
        </td>
      </tr>
    </table>
...
function validate(){
  ...
  //validate account
  if(acct == 'Select account type') {
      document.getElementById('acctErr').innerHTML = "* Please select account type";
      document.getElementById('acct').style.border = '1.5px solid red';
  } else {
         document.getElementById('acctErr').innerHTML = "";
         document.getElementById('acct').style.border = '1.5px solid green';
      }
  ...
  //validate nic
  if(nic == '') {
      document.getElementById('nicErr').innerHTML = "* Please enter your nic";
      document.getElementById('nic').style.border = '1.5px solid red';
  } else {
         document.getElementById('nicErr').innerHTML = "";
         document.getElementById('nic').style.border = '1.5px solid green';
      }
